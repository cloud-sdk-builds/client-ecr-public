...
[`@aws-sdk/client-ecr-public`](https://www.npmjs.com/package/@aws-sdk/client-ecr-public/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ecr-public@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ASwdtQgyRWmVdV6vPrWc85vsqlshhAkF8b1JoVVW+H3HmVPpy2MQHo4ryKpiPmsj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ecr-public": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ecr-public@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ecr-public@3.224.0/index.min.mjs": "sha384-ASwdtQgyRWmVdV6vPrWc85vsqlshhAkF8b1JoVVW+H3HmVPpy2MQHo4ryKpiPmsj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ecr-public/blob/refs/tags/3.224.0/LICENSE
```
